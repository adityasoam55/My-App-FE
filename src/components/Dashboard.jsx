        ...
        <div className="bg-white/80 backdrop-blur-md p-8 rounded-2xl shadow-2xl max-w-3xl mx-auto transition-all duration-700 transform hover:scale-[1.01] hover:shadow-blue-200">
          ...
          <div className="mt-10">
            ...
            >
              ...
              <button
                type="submit"
                className="bg-gradient-to-r from-green-500 to-green-600 text-white px-5 py-2 rounded-full font-semibold shadow-md hover:from-green-600 hover:to-green-700 transform hover:scale-105"
              >
              ...
              {editTask && (
                <button
                  ...
                  className="ml-4 bg-gray-500 text-white px-5 py-2 rounded-full font-semibold shadow-md hover:bg-gray-600"
                >
                  Cancel Edit
                </button>
              )}
            ...
            {/* TASK LIST — UPDATED FOR RESPONSIVENESS */}
              ...
              {filteredTasks.length === 0 ? (
                ...
                filteredTasks.map((task) => (
                  ...
                  >
                    ...
                    {/* Buttons Responsive */}
                    <span className="flex flex-wrap md:flex-nowrap gap-2 w-full md:w-auto">
                      <button
                        onClick={() => handleToggleComplete(task)}
                        className="bg-blue-500 text-white px-2 py-1 rounded hover:bg-blue-600 transition-all h-10 w-full md:w-32"
                      >
                      ...
                      <button
                        ...
                        className="bg-yellow-500 text-white px-2 py-1 rounded hover:bg-yellow-600 transition-all h-10 w-full md:w-12"
                      >
                        Edit
                      </button>
                      ...
                      <button
                        ...
                        className="bg-red-500 text-white px-2 py-1 rounded hover:bg-red-600 transition-all h-10 w-full md:w-20"
                      >
                        Delete
                      </button>
                    </span>
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-10">
            <button
              ...
              className="bg-gradient-to-r from-red-500 to-red-600 text-white px-5 py-2 rounded-full font-semibold shadow-md hover:from-red-600 hover:to-red-700 transform hover:scale-105"
            >
              Logout
            </button>
          </div>
